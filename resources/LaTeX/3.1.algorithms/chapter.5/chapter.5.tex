...
\input{../resources/LaTeX/3.1.algorithms/3122/3122.tex}
\vspace{1\baselineskip}
\begin{center}
    \lstinputlisting[language=Python, title=\textbf{\color{darkgray}Python}]{../resources/Python/3.1.algorithms/3122.py}
\end{center}
\pagebreak
\begin{center}
    \lstinputlisting[language=Java, title=\textbf{\color{darkgray}Java}, firstline=12, lastline=30]{../resources/Java/3.1.algorithms/j3122.java}
\end{center}
